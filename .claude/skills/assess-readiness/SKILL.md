...
- **C1.1 Codebase Accessibility** — follow the `/verify-c1-1` skill
- **C2.1 Setup Automation** — follow the `/verify-c2-1` skill
- **C3.1 Architecture Depth** — follow the `/verify-c3-1` skill
- **C4.1 Requirements Access** — follow the `/verify-c4-1` skill
